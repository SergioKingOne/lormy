      ...
      <main>
        ...
        <section id="services" className="py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-serif text-center text-neutral-800 mb-12">
              Our Services
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-[#FEBAB9]/5 p-8 rounded-lg text-center">
                ...
                <p className="text-neutral-600">
                  Beautiful makeup to make your quinceañera celebration
                  unforgettable
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="aspect-square bg-[#FEBAB9]/20 rounded-lg"
                />
              ))}
            </div>
          </div>
